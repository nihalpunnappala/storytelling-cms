    ...
    const fetchAttendanceData = async () => {
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          // Group registrations by ticket type and count
          registrationData.forEach((registration) => {
            if (registration.ticket && registration.ticket._id) {
              const ticketId = registration.ticket._id;
              const ticketTitle = registration.ticket.title || "Unknown Ticket";
              ...
              // Count all registrations by ticket type
